        ...
        <div className="flex-grow mx-4 max-w-xl">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-1 rounded-full border border-gray-300 focus:outline-none focus:ring-1 focus:ring-orange-500"
            />
            <FaSearch className="absolute right-4 top-2 cursor-pointer text-orange-500" />
          </div>
        </div>
